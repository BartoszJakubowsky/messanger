...
export default function Sidebar() {
    ...
    return (
        ...
        <nav className={`${isOpen? 'sm:w-[600px] w-4/6  translate-x-0' : 'md:w-0 md:[&>*]:invisible w-full -translate-x-full -ml-4'} absolute md:relative inset-0  transition-all duration-150 ease-in-out p-2 flex flex-col gap-2 dark:bg-indigo-800 bg-pink-200 overflow-x-hidden`}>
          <div className="max-w-[325px] min-w-[325px]">
